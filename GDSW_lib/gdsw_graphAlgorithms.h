...
public:
	...
	void computeMeshGraphSkinningData(SN::SkeletonNode* currentSkeletonRoot, MeshGraph * pMesh, ObjectSkeletonShaderData * data, bool isMeshGraphComputed, Array2D<float> distanceMatrix, int numOfControlBones, int maxBones);
};
//---------------------------------------------------------------------------
#endif
